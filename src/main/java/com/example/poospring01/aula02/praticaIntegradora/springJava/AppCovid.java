...
public class AppCovid {
    public static void main(String[] args) {
        ...
        Pessoa p1 = new Pessoa("PES01", "Mariana", "Saraiva", 61);
        Pessoa p2 = new Pessoa("PES02", "Hugo", "Daniel", 22);
        Pessoa p3 = new Pessoa("PES03", "Gabriel", "Fontes", 19);
        Pessoa p4 = new Pessoa("PES04", "Nathalia", "Miranda", 67);
